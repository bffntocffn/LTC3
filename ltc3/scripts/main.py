...
from ltc3.util.relax import aar_from_config
from ltc3.util.phonopy_utils import wrap_atoms, rotate_atoms, get_spgnum
from ltc3.util.logger import Logger, LOG_ORDER
from ltc3.scripts.parse_input import parse_config
from ltc3.scripts.process_fcs import process_fcs_for_ph3
from ltc3.scripts.process_conductivity import (
...
def main():
    ...
    logger.writeline(f'Reading config file {config_path} for ltc3.')
